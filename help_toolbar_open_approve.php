<?php
/**
 * help_toolbar_open_approve.php
 *
 * @package   PhpStorm
 * @file      help_toolbar_open_approve.php
 * @author    gparkin
 * @date      1/18/17
 * @version   7.0
 *
...
<p style="font-size: 18px;">
    This screen is used to view and approve work requests for your net-group or subscriber group. It works just like
    the Open tickets screen from the toolbar menu. The only difference is that it only shows tickets, servers and
    contacts (net-pins) where you need to be concerned about.
    <br><br>
    Keep in mind that the server status may or may not change after you approve the work request. If there is one or
    more contact for the server they may not have approved the work yet. The approve work status will not change for
    a server until all contacts have approved the work. If you are the last one to approve the work for a server the
    server work status will change to approve and will be changed in the grid.
    <br><br>
    There are two places where you can approve the work. The first method is by clicking in the row containing the
    ticket. When the dialog box appears there is a button all "Approve All". Clicking on this button will approve this
    work on all the servers you may be supporting that are listed in the ticket. This is the fastest way to approve
    the work, but you will want to make sure you review the servers and the scheduled start times carefully before using
    this option. The second way to approve the work is to find the server in the by opening the sub grids that show the
    servers and contacts. Find your net group pin contact and click on it. When the information about your group
    appears there will be an approve button there to click on.
</p>

<br>
<h3>Main Grid</h3>
<p style="font-size: 18px;">
    <img src="help/toolbar_approve/a1.png">
    The following is a grid contains tickets that you need to be concerned with.
</p>
...
<p style="font-size: 18px;">
    ...
    As you expand a record by clicking on the plus sign, all servers that you are requested to approve or review will
    be displayed and all servers that don't concern you are hidden. When you expand the server records, only contacts
    records where you are a member of it's net-group are shown. If the contact is from the subscriber list you will see a
    group number starting with SUBxxx where SUB tells you this is a subscriber's list. When you click on the contact
    record you will be presented with buttons that you can click on to choose how you approve the work. Please
    keep in mind the final server approval status will not change until everyone has approved the work request.
</p>
...
<p style="font-size: 18px;">
    ...
    CCT owner or CCT admin you will not be able to approve all, cancel or update the ticket. But you can look at detail
    information about the work request. However you can still log messages and send out email for the ticket.<br><br>
    If you Approve All from this dialog box, CCT will approve all the servers you support that are listed in this
    ticket. This is a handy option if the SA is targeting 100's of servers where you are a support contact for most of
    them. This will save you time from clicking on each server in the sub-grids and approving each server one by one.
    <br><br>
    The <b>Approve All - With Paging</b> button means that the on-call person for your group will be paged about work
    status so they have an opportunity to shutdown their applications, do manual restarts of their application and check
    things out to see if anything broken.<br><br>
    The <b>Approve All - NO PAGING</b> option means no pages will be sent out to your on-call net-group. In other words,
    you do not have to worry about things starting back up. You will still get an email about the work status the next
    day.<br><br>
    As you approve work for your net-group the tickets will be removed from your approve list. If you need to come back
    into CCT later and look at the ticket again, you can use the search button on the toolbar to find the ticket and
    servers you support again. From there you can add additional log information for the SA doing the work and even
...
<p style="font-size: 18px;">
    ...
    take time to retrieve and display the ticket.
</p>
...
<p style="font-size: 18px;">
    ...
    Additional information on what the different buttons do are listed in the dialog box.<br><br>
    <b>Approve - With Paging</b> means the on-call person for your net-group will be paged during the work activity
    so they can perform any work activities on their part to ensure their application is working properly.<br><br>
    <b>Approve - NO PAGING</b> means you don't want any pages sent out to your on-call net-group person.
</p>
...
<br>
<h3>Contact Dialog Box - Send Email (tab)</h3>
<p style="font-size: 18px;">
