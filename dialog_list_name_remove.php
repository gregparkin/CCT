<?php
/**
 * dialog_list_name_remove.php
 *
 * @package   PhpStorm
 * @file      dialog_list_name_remove.php
 * @author    gparkin
 * @date      6/30/16
 * @version   7.0
 *
...
$lib->debug_start('dialog_list_name_remove.html');
...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteList()
        {
            ...
            var url = 'ajax_dialog_list_name_remove.php';
...
<form name="f1">
    <table bgcolor="#ECE9D8" width="100%" cellspacing="2" cellpadding="2" style="color: black">
        <tr>
            <td align="center">
                <p>Confirm that you want to remove: <?php echo $list_name; ?></p>
            </td>
        </tr>
        <tr>
            <td align="center">
                <a class="green" title="Okay to delete this server list?"
                   href="#" onclick="deleteList()">Yes</a>
