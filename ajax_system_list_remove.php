<?php
/**
 * ajax_system_list_remove.php
 *
 * @package   PhpStorm
 * @file      ajax_system_list_remove.php
 * @author    gparkin
 * @date      7/1/16
 * @version   7.0
 *
 * @brief     Called by toolbar_server_list.php to remove a list of checked servers from cct7_list_systems
 *
 */
