<?php
/**
 * dialog_override_netpins_remove.php
 *
 * @package   PhpStorm
 * @file      dialog_override_netpins_remove.php
 * @author    gparkin
 * @date      07/24/17
 * @version   7.0
 *
 * @brief     Called by toolbar_override_netpins.php to prompt users to remove override list: Y/N
 *
 */
...
$lib->debug_start('dialog_override_netpins_remove.html');
...
if ($ora->sql2($query) == false)
{
    ...
    printf("Override no longer exists.  netpin_id = %d", $netpin_id);
    exit();
}
...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteNetpin()
        {
            ...
            var url = 'ajax_dialog_override_netpins_remove.php';
...
<form name="f1">
    <table bgcolor="#ECE9D8" width="100%" cellspacing="2" cellpadding="2" style="color: black">
        <tr>
            <td align="center">
                <p>Confirm that you want to remove: <?php echo $netpin_no; ?></p>
            </td>
        </tr>
        <tr>
            <td align="center">
                <a class="green" title="Okay to delete this server list?"
                   href="#" onclick="deleteNetpin()">Yes</a>
                <a class="red" title="No I do not want to remove this list."
