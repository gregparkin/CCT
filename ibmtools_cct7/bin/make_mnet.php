...
//
// This script runs cct7_mnet.sql from the sql directory to rebuild the cct7_mnet table.
//
// The SQL script downloads data from Asset Manager using two Oracle views that Joel Noble setup.
// cs_qwestibm_mnet@itast
...
//
// Download Asset Manager data into cct7_mnet
//
if ($s->sqlplus("/opt/ibmtools/cct7/bin/sql/cct7_mnet.sql") == false)
{
