...
create table cct7_mnet as select * from cct6_mnet;

drop table new_cct7_mnet;
drop table cct7_mnet_backup;
drop index idx_cct7_mnet_1;
drop index idx_cct7_mnet_2;
drop index idx_cct7_mnet_3;
drop index idx_cct7_mnet_4;
drop index idx_cct7_mnet_5;
...
select count(*) as cct7_mnet from cct7_mnet;
